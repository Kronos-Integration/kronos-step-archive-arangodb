 ...
 */
export class StepArchiveArango extends Step {
  static get name() {
    return 'kronos-step-archive-arangodb';
  }
  static get description() {
    return 'Saves an element to the archive store';
  }
...
export async function registerWithManager(manager) {
  await manager.registerStep(StepArchiveArango);
}
